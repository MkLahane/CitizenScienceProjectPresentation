...
const presentImgs = getImgs('farming/present/');
const notPresentImgs = getImgs('farming/not_present/');



const slide13 = (
    <Slide key={12} slideIndex={12}>
        <div className='slide7-div'>
            <Title titleText="My contribution" slideIndex={12} style={{
                textAlign: 'center',
                position: 'absolute',
                left: '50%',
